...
public class EBCConfigGroup extends ReflectiveConfigGroup {
	static public final String GROUP_NAME = "ebc";
	...
	static public final String SPEDELEC_AVAILABILITY = "spedelecAvailability";
	...
	private double spedelecAvailability = 0.04;
	...
	@StringGetter(SPEDELEC_AVAILABILITY)
	public double getSpedelecAvailability() {
		return spedelecAvailability;
	}

	@StringSetter(SPEDELEC_AVAILABILITY)
	public void setSpedelecAvailability(double spedelecAvailability) {
		this.spedelecAvailability = spedelecAvailability;
	}
	...
	static public EBCConfigGroup get(Config config) {
		if (!config.getModules().containsKey(GROUP_NAME)) {
			config.addModule(new EBCConfigGroup());
		}

		return (EBCConfigGroup) config.getModules().get(GROUP_NAME);
	}
}