...
public class EBCPtVariables extends PtVariables {
	...
	public EBCPtVariables(PtVariables delegate, double railTravelTime_min, double busTravelTime_min,
			double headway_min, OVGK ovgk, double distance) {
		...
		this.ovgk = ovgk;
		this.inVehicleDistance_km = distance;
	}
}
